...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFE188C6CE0>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.ShaderVariable' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.ShaderVariable' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.ShaderVariable' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.ShaderVariable' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.ShaderVariable' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.ShaderVariable' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.ShaderVariable' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.ShaderVariable' objects>, 'RowMajor': <method 'RowMajor' of 'renderdoc.ShaderVariable' objects>, 'ColMajor': <method 'ColMajor' of 'renderdoc.ShaderVariable' objects>, 'SetTypelessPointer': <method 'SetTypelessPointer' of 'renderdoc.ShaderVariable' objects>, 'SetTypedPointer': <method 'SetTypedPointer' of 'renderdoc.ShaderVariable' objects>, 'GetPointer': <method 'GetPointer' of 'renderdoc.ShaderVariable' objects>, 'SetBindIndex': <method 'SetBindIndex' of 'renderdoc.ShaderVariable' objects>, 'GetBindIndex': <method 'GetBindIndex' of 'renderdoc.ShaderVariable' objects>, 'value': <attribute 'value' of 'renderdoc.ShaderVariable' objects>, 'name': <attribute 'name' of 'renderdoc.ShaderVariable' objects>, 'members': <attribute 'members' of 'renderdoc.ShaderVariable' objects>, 'rows': <attribute 'rows' of 'renderdoc.ShaderVariable' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.ShaderVariable' objects>, 'type': <attribute 'type' of 'renderdoc.ShaderVariable' objects>, 'flags': <attribute 'flags' of 'renderdoc.ShaderVariable' objects>, 'columns': <attribute 'columns' of 'renderdoc.ShaderVariable' objects>, '__doc__': '\\nHolds a single named shader variable. It contains either a primitive type (up to a 4x4\\nmatrix of a :class:`basic type <VarType>`) or a list of members, which can either be struct or array\\nmembers of this parent variable.\\n\\nMatrices are always stored row-major. If necessary they are transposed when retrieving from the raw\\ndata bytes when they are specified to be column-major in the API/shader metadata.\\n\\n'})"
