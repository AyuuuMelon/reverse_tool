...
"""
    ...
    __dict__ = None # (!) real value is "mappingproxy({'this': <attribute 'this' of 'SwigPyObject' objects>, 'thisown': <attribute 'thisown' of 'SwigPyObject' objects>, '__new__': <built-in method __new__ of SwigPyObjectType object at 0x00007FFE188C5070>, '__hash__': <slot wrapper '__hash__' of 'renderdoc.SDFile' objects>, '__lt__': <slot wrapper '__lt__' of 'renderdoc.SDFile' objects>, '__le__': <slot wrapper '__le__' of 'renderdoc.SDFile' objects>, '__eq__': <slot wrapper '__eq__' of 'renderdoc.SDFile' objects>, '__ne__': <slot wrapper '__ne__' of 'renderdoc.SDFile' objects>, '__gt__': <slot wrapper '__gt__' of 'renderdoc.SDFile' objects>, '__ge__': <slot wrapper '__ge__' of 'renderdoc.SDFile' objects>, '__init__': <slot wrapper '__init__' of 'renderdoc.SDFile' objects>, 'Swap': <method 'Swap' of 'renderdoc.SDFile' objects>, 'chunks': <attribute 'chunks' of 'renderdoc.SDFile' objects>, '__dict__': <attribute '__dict__' of 'renderdoc.SDFile' objects>, 'version': <attribute 'version' of 'renderdoc.SDFile' objects>, 'buffers': <attribute 'buffers' of 'renderdoc.SDFile' objects>, '__doc__': 'Contains the structured information in a file. Owns the buffers and chunks.'})"
