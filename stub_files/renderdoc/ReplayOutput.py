...
class ReplayOutput(): # skipped bases: <class 'SwigPyObject'>
    ...
    def SetDimensions(self, width: int, height: int): # real signature unknown; restored from __doc__
        """
